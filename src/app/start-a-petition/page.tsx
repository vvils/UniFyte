            ...
            <div className='flex justify-center mt-16'>
                <div className='flex flex-col items-center row-auto'>
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Enter a University" className="mt-8 w-full p-2 rounded-md border-2"/>
                    ...
                    {currentQuestionIndex === 2 && (
                        <div>
                            <h1 className='md:font-bold text-5xl'>Write your Petition Title</h1>
                            <input type="text" placeholder="Enter your title" className="mt-8 w-full p-2 rounded-md border-2"/>
                        </div>
                    )}

                    {currentQuestionIndex === 3 && (
                        <div>
                            <h1 className='md:font-bold text-5xl'>Write are you writing about?</h1>
                            {/* <textPrompt/> */}
                        </div>
                    )}
                    ...
                    <div className="flex-row">
                        <button className="border-2 rounded-xl mt-12 text-xl p-4" onClick={() => {decrementCounter()}}> Back</button>
                        <button className="bg-blue-300 border-2 rounded-xl ml-4 mt-12 text-xl p-4"
